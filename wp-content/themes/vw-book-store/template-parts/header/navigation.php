...
<div id="header" class="menubar <?php if( get_theme_mod( 'vw_book_store_sticky_header',true) != '') { ?> header-sticky"<?php } else { ?>close-sticky <?php } ?>">
  <div class="container">
    <div class="row bg-home">
      ...
      <div class="<?php echo esc_html( $colmd ); ?>">
        <div class="toggle-nav mobile-menu">
          <button onclick="vw_book_store_menu_open_nav()"><i class="<?php echo esc_attr(get_theme_mod('vw_book_store_res_open_menus_icon','fas fa-bars')); ?>"></i><span class="screen-reader-text"><?php esc_html_e('Open Button','vw-book-store'); ?></span></button>
        </div>
      ...
      <?php if ( 'Disable' != $vw_book_store_search_hide_show ) {?>
        <div class="search-box col-lg-1 col-md-1 col-6">
          <a href="#" onclick="vw_book_store_search_open()"><span><i class="fas fa-search"></i></span></a>
        </div>
      <?php } ?>
    </div>
    <div class="serach_outer">
      ...
      <a href="#main" onclick="vw_book_store_search_close()" class="closepop"><i class="fa fa-window-close"></i></a>
    </div>
  </div>
</div>